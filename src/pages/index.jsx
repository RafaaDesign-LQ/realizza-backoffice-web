...
const Page = ({ params }) => {
  ...
  useEffect(() => {
    fetch(`http://localhost:3000/purchase-transactions`).then(async (response) => {
          ...
          <Grid container spacing={3}>
            <Grid xs={12} sm={12} lg={4}>
              <OverviewBudget
                ...
                positive
                sx={{ height: "100%" }}
                value={Number(approved?.reduce((acc, curr) => acc + curr.amount, 0)).toLocaleString(
                  "pt-BR",
            ...
            <Grid xs={12} sm={12} lg={4}>
              <OverviewTasksProgress sx={{ height: "100%" }} value={percentage} />
            </Grid>
            <Grid xs={12} sm={12} lg={4}>
